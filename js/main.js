...
require([
    ...
    function(dom, dc, on, parser, ready, Map, Locator, BasemapToggle, InfoTemplate, FeatureLayer, Popup, Legend, CheckBox, arrayUtils, Graphic, Point, PictureMarkerSymbol, SimpleFillSymbol, SimpleLineSymbol, SimpleMarkerSymbol, Color) {
        parser.parse();
        ...
        ready(function() {
          ...
          var popup = new Popup({
            ...
            locator = new Locator(appConfig.locatorURL);
          ...
          //TOC Layers
          //=================================================================================>
          tocLayers.push({layer: bikeshops, title: "Bike Shops"});
          tocLayers.push({layer: bikepics, title: "Bikeways Pics"});
          tocLayers.push({layer: transit, title: "Transit Locations"});
          tocLayers.push({layer: lightrail, title: "Light Rail"});

          // Legend Layers
          //=================================================================================>
          legendLayers.push({layer: bikepics, title: "Bikeways Pics"});
          legendLayers.push({layer: bikeshops, title: "Bike Shops"});
          legendLayers.push({layer: transit, title: "Transit Locations"});
          legendLayers.push({layer: lightrail, title: "Light Rail"});
          legendLayers.push({layer: crossings, title: "Bikeways Crossings"});
          legendLayers.push({layer: bikeways, title: "Bikeways Types"});
    ...
    function getLocation() {
      if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(zoomToLocation, locationError, {setHighAccuracy:true});
      }
    }
...
function openemailwin() {
    var emailURL = href = appConfig.jasonemail;
